...
void CDoubleGoer::NpcSilverRewardChest(LPOBJ lpNpc,LPOBJ lpObj) // OK
{
	...
	{
		case 0:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_DOUBLE_GOER,0,0,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
			break;
		case 1:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_DOUBLE_GOER,1,0,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
			break;
		case 2:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_DOUBLE_GOER,2,0,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
			break;
		case 3:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_DOUBLE_GOER,3,0,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
			break;
		case 4:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_DOUBLE_GOER,4,0,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
			break;
		default:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_DOUBLE_GOER,5,0,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
			break;
	}
...
void CDoubleGoer::NpcGoldenRewardChest(LPOBJ lpNpc,LPOBJ lpObj) // OK
{
	...
	{
		case 0:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_DOUBLE_GOER,0,1,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
			break;
		case 1:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_DOUBLE_GOER,1,1,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
			break;
		case 2:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_DOUBLE_GOER,2,1,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
			break;
		case 3:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_DOUBLE_GOER,3,1,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
			break;
		case 4:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_DOUBLE_GOER,4,1,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
			break;
		default:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_DOUBLE_GOER,5,1,lpObj,lpNpc->Map,lpNpc->X,lpNpc->Y);
			break;
	}
