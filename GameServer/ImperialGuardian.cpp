...
void CImperialGuardian::DropSideBossItem(LPOBJ lpObj,LPOBJ lpTarget) // OK
{
	...
	{
		case 0:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_IMPERIAL_GUARDIAN,0,0,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
			break;
		case 1:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_IMPERIAL_GUARDIAN,1,0,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
			break;
		case 2:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_IMPERIAL_GUARDIAN,2,0,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
			break;
		case 3:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_IMPERIAL_GUARDIAN,3,0,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
			break;
		case 4:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_IMPERIAL_GUARDIAN,4,0,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
			break;
		default:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_IMPERIAL_GUARDIAN,5,0,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
			break;
	}
...
void CImperialGuardian::DropMainBossItem(LPOBJ lpObj,LPOBJ lpTarget) // OK
{
	...
	{
		case 0:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_IMPERIAL_GUARDIAN,0,1,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
			break;
		case 1:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_IMPERIAL_GUARDIAN,1,1,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
			break;
		case 2:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_IMPERIAL_GUARDIAN,2,1,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
			break;
		case 3:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_IMPERIAL_GUARDIAN,3,1,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
			break;
		case 4:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_IMPERIAL_GUARDIAN,4,1,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
			break;
		default:
			gItemBagManager.DropItemBySpecialValue(ITEM_BAG_SPECIAL_IMPERIAL_GUARDIAN,5,1,lpTarget,lpObj->Map,lpObj->X,lpObj->Y);
			break;
	}
